...
/**
 * 일반적인 함수 정의는 매개변수를 몇개 선언할지 미리 지정해두게 됩니다. 2개 지정하면 무조건 argument가 두개 필요하고 4개 지정하면 4개의 argument가 필요하겠네요.
 * 즉 정해진 argument를 충족하는 선에서 개발자가 머리 써서 몇 번 호출할지를 고민해야 합니다. 법위를 벗어나게 되면 계산 자체가 불가능할 수도 있겠네요
 * 
